          ...
          <div className="profile-card">
            <div className="profile-avatar-section">
              <div className="profile-avatar">
                <span>{workerData?.avatar || 'W'}</span>
              </div>
              <div className="profile-basic-info">
                <h2>{workerData?.full_name || 'Worker'}</h2>
            ...
            <div className="profile-details">
              ...
              <div className="form-group">
                ...
                <div className="form-display">{workerData?.email}</div>
              ...
              <div className="form-group">
                ...
                <div className="form-display">
                  {workerData?.created_at
                    ? new Date(workerData.created_at).toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',
                      })
